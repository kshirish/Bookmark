		...
		<Container>			
			<Row>
				<Col sm="12" md={{ size: 8, offset: 2 }}>
					...
					<p>Follow us on <a target="_blank" rel="noopener noreferrer" href="//twitter.com">Twitter</a> or <a target="_blank" rel="noopener noreferrer" href="//facebook.com">Facebook</a> for the latest news.</p>
				</Col>
			</Row>	
		</Container>			        
	</div>
